...
async def environment_button(message:types.Message):
    await message.answer(
        "🌿 <b>Окружение</b>\\n\\n"
        "Раздел для природных и экологических показателей.\\n\\n"
        "🌫 Качество воздуха\\n"
        "☀️ УФ-индекс\\n"
        "🌲 Риск природных пожаров\\n"
        "🌾 Пыльца и аллергены — если будет доступен источник данных\\n"
        "🌊 Температура воды — если будет доступен источник данных",
